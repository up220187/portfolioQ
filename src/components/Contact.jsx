      ...
      <div className={styles.container}>
        ...
        >
          ...
          <h2 className={styles.title}>
            Trabajemos <span className={styles.accent}>juntos</span>
          </h2>

          <p className={styles.subtitle}>
            Estoy abierta a oportunidades como Frontend Developer, Junior Developer
            o prácticas profesionales donde pueda aportar valor y seguir creciendo
            en entornos técnicos de alto nivel.
          </p>
